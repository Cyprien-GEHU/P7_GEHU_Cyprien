...
<MqResponsive target="md+">
  <main>
    ...
    <ul id="formulaire">
      <div id="formualaire_crea"> 
        ...
        <div class="text">
          ...
          <div v-if="image">
            <img :src="time_image" class="photo">
          </div>
        </div>
    ...
    <button type ="submit" @click="envoie()">Crée le Post</button>
  </main>
</MqResponsive>
  ...
  <main>
    ...
    <ul id="formulaire_mobile">
      <div id="formualaire_crea"> 
        ...
        <div class="text">
          <li><label for="image" class="size" >Photo ou image</label></li>
          <li><input type="file" @change="photo" required id="file"></li>
          <div v-if="image">
            <img :src ="time_image" alt="image du post selectionner" class="photo_mobile"/>
          </div>
        </div>
    ...
    <ul id="formulaire_mobile">
      <div id="formualaire_crea"> 
        ...
        <div class="text">
          ...
          <li><input type="file" @change="photo" required id="file"></li>
          <div v-if="image">
            <img :src ="time_image" alt="image du post selectionner" class="photo_tablette"/>
          </div>
        </div>
...
export default {
  ...
  methods: { 
    ...
    axios
      .post('http://localhost:3000/api/groupomania/New', post,{ headers:{
